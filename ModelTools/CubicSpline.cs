...
namespace ModelTools
{
    ...
    public class CubicSpline
    {
        ...
        public static double getValue(double[] x, double[] y, double xs)
        {
            ...
            try {
                CubicSpline spline = new CubicSpline();
                double[] xs0 = new double[1] { xs };
                double[] ys0 = spline.FitAndEval(x, y, xs0, startSlope, endSlope, debug);
                double ys = ys0[0];
                return ys;
            }
            catch
        ...
        public static double[] getValue(double[] x, double[] y, double[] xs)
        {
            ...
            {
                CubicSpline spline = new CubicSpline();
                double[] ys = spline.FitAndEval(x, y, xs, startSlope, endSlope, debug);
                return ys;
            }
            catch
            {
